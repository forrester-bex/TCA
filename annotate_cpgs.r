...
write.csv(hire1_anno, file="hire1.bed")
write.csv(hire2_anno, file="hire2.bed")
write.csv(hire3_anno, file="hire3.bed")
write.csv(hire4_anno, file="hire4.bed")
write.csv(hire5_anno, file="hire5.bed")
write.csv(hire6_anno, file="hire6.bed")
write.csv(tca1_anno, file="tca1.bed")
write.csv(tca2_anno, file="tca2.bed")
write.csv(tca3_anno, file="tca3.bed")
write.csv(tca4_anno, file="tca4.bed")
write.csv(tca5_anno, file="tca5.bed")
write.csv(tca6_anno, file="tca6.bed")
